...
const UnsavedChangesBar = ({ show, saving, onSave, onReset, message = 'Careful — you have unsaved changes!' }) => {
  ...
  return (
    <div className="sticky bottom-0 z-50 flex justify-center pb-2 pt-4">
      <div className="flex w-full items-center justify-between gap-2 rounded-md border border-primary/20 bg-primary/5 px-4 py-3 shadow-lg backdrop-blur-md animate-in fade-in slide-in-from-bottom-2">
